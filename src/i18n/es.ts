export const es = {
    ...
    chatbot: {
        ...
        hobbies: "Juego LoL, Minecraft y The Binding of Isaac. También me apasiona la naturaleza, los animales y el senderismo. Mi color favorito es el verde, por si no se nota en la terminal.",
        philosophy: "Soy una navaja suiza: disfruto aprendiendo de todo. Nunca me oirás decir 'no sé' sin añadir un 'pero lo aprendo ya mismo'. El 'no puedo' no existe en mi sistema.",
