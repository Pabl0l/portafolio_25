export const de = {
    ...
    chatbot: {
        ...
        contact: "Du kannst mich per E-Mail unter jpom1310@gmail.com erreichen oder mich auf LinkedIn und GitHub als Pabl0l finden. Schick keine Rauchzeichen; die ignoriere ich.",
        experience: "Ich bin derzeit Wartungstechniker bei Mired IPS. Einmal habe ich das Internet eines ganzen Büros in 5 Minuten repariert, nur weil ein paar Genies das RACK ausgesteckt haben, um die Wand zu streichen. So ist das Leben.",
        certifications: "Ich habe mehrere Cisco-Zertifizierungen. Ich weiß, wie man einen Router konfiguriert und warum man den Maler nicht an die RACK-Kabel lassen sollte.",
