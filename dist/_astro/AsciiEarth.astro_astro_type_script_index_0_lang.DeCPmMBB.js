document.addEventListener("DOMContentLoaded",()=>{const o=document.getElementById("ascii-earth");if(!o)return;const s=[`
                       .-/+ossooooooo+/:.
                 .:osydhyo++:     :yyyyydN@ho:.
              :sho:...       .+o..d@h./N@@@@@@@@s:
           -s@dd-           :--@s@@@@@@@@@@@@@@@@@Ny:
        ...
        .+@y.                             ........../yo.
           :ys:                         .........:sy/
             ./ss+-.                  .......-+ss/.
                 ./oso+:-.  ..:::::     ++oysso/.
                      .-:+ooshhhhhhyso+/-.
`];let y=0;function h(){s.length>0?(o.textContent=s[y],y=(y+1)%s.length):o.textContent="Please add ASCII art frames to the 'frames' array in AsciiEarth.astro!"}setInterval(h,150)});
